...
class Keuangan extends CI_Controller{
    ...
    function load_data_siswa_by_rombel(){
	    ...
	    echo "<table class='table table-bordered'>
	        <tr><th width='90'>NIS</th><th>NAMA</th><th>SUDAH BAYAR</th></tr>";
	    ...
	    foreach ($siswa->result() as $row){
	        ...
	        <td>$row->nis</td>
	        <td>$row->nama</td>
	        <td>".$this->__check_jumlah_yang_sudah_dibayar($row->nis, $id_jenis_pembayaran)."</td>
	        </tr>";
	    }
	    echo"</table>";
	  }
	...
	function __check_jumlah_yang_sudah_dibayar($nis,$id_jenis_pembayaran){
		$pembayaran = $this->db->get_where('tbl_pembayaran',array(
			'nis'				 => $nis,
