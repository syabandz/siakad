...
Class Kurikulum extends CI_Controller {
        ...
        $columns = array(
            ...
            array(
                ...
                'formatter' => function( $d) {
                    ...
                    return 
                           anchor('kurikulum/edit/' . $d, '<i class="fa fa-edit"></i>', 'class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit"') . '
    ...
    function dataKurikulumDetail(){
        ...
        foreach ($kurikulum as $row){
            echo"<tr><td>$no</td><td>$row->kd_mapel</td><td>$row->nama_mapel</td><td>$row->kelas</td><td>".anchor('kurikulum/deletedetail/'.$row->id_kurikulum_detail.'/'.$row->id_kurikulum,'<i class="fa fa-trash-o"></i>')."</td></tr>";
            $no++;
        }
