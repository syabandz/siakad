            ...
            <table class="table table-bordered">
                ...
                foreach ($jenis_pembayaran->result() as $row) {
                    echo "<tr>
                        ...
                        <td><input type='int' value='".  chek_komponen_biaya($row->id_jenis_pembayaran)."' class='form-control'
                         name='$row->id_jenis_pembayaran' placeholder='Masukan Data $row->nama_jenis_pembayaran'></td></tr>";
                }
                ?>
