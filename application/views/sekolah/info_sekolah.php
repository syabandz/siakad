<div class="col-sm-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?php
            echo form_open('sekolah/edit', 'role="form" class="form-horizontal"');
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" value="<?php echo $sekolah['nama_sekolah'];?>" name="nama_sekolah" placeholder="MASUKAN NAMA SEKOLAH" id="form-field-1" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-1">
                ...
                <div class="col-sm-9">
                    <input type="text" name="alamat_sekolah" value="<?php echo $sekolah['alamat_sekolah'];?>" placeholder="MASUKAN ALAMAT SEKOLAH" id="form-field-1" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-1">
