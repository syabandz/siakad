                            ...
                            <div class="panel-body">
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" value="<?php echo $tahun_akademik['tahun_akademik']?>" name="tahun_akademik"placeholder="TAHUN AKADEMIK" id="tahun_akademik" class="form-control" type="text">
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                          ...
                                          <div class="col-sm-1">
                                           ...
                                           <?php echo anchor('tahun_akademik','KEMBALI',array('class'=>'btn btn-info btn-sm'));?>
                                        </div>
                                    </div>
