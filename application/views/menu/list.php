...
<div class="col-sm-12">
    ...
    <div class="panel-heading">
            <i class="fa fa-external-link-square"></i> Data Menu
        ...
        <div class="panel-body">
            <?php echo anchor('menu/add','Tambah data',array('class'=>'btn btn-success btn-sm'))?><br /><br />
                ...
                <table id="mytable" class="table table-striped table-bordered table-hover table-full-width dataTable">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">IS MAIN MENU</th>
                            <th>AKSI</th>
                        </tr>
                    </thead>
                </table>
        ...
        if (isConfirm) {
            $.ajax({
                ...
                success: function(data) {
                    window.location.href = "<?php echo site_url('menu'); ?>";
                },
                error: function() {
                    swal({
                        type : "error",
