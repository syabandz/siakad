                            ...
                            <div class="panel-body">
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="nama_menu"placeholder="NAMA MENU" id="form-field-1" class="form-control" type="text">
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text"  name="link" placeholder="MASUKAN NAMA MATA PELAJARAN" id="form-field-1" class="form-control" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="icon"placeholder="ICON" id="form-field-1" class="form-control" type="text">
                                        </div>
                                    </div>
